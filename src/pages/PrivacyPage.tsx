    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="p-8 space-y-8 bg-white rounded-lg shadow-sm">
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">1. 개인정보의 수집 및 이용 목적</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">2. 수집하는 개인정보 항목</h2>
            <div className="space-y-3">
              <div>
                <h3 className="mb-2 font-semibold text-gray-800">필수 항목</h3>
              ...
              <div>
                <h3 className="mb-2 font-semibold text-gray-800">자동 수집 항목</h3>
                <ul className="space-y-1 text-gray-700 list-disc list-inside">
                  <li>서비스 이용 기록</li>
                  <li>접속 로그</li>
                  <li>쿠키 정보</li>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">3. 개인정보의 보유 및 이용 기간</h2>
            <p className="mb-2 leading-relaxed text-gray-700">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">5. 개인정보의 파기</h2>
            <p className="mb-2 leading-relaxed text-gray-700">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">6. 정보주체의 권리·의무 및 행사방법</h2>
            <p className="mb-2 leading-relaxed text-gray-700">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">7. 개인정보 보호책임자</h2>
            <div className="p-4 rounded-lg bg-gray-50">
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:sjhsjh8520@korea.ac.kr" className="text-indigo-600 hover:text-indigo-700">
                  sjhsjh8520@korea.ac.kr
                </a>
              </p>
            </div>
          </section>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">8. 개인정보 처리방침 변경</h2>
            <p className="leading-relaxed text-gray-700">
